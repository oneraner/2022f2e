          ...
          <ul>
            <li className="mb-20">
              <p className="text-white flex items-center mb-7">
                <span className="text-[#3484C6] text-5xl">＜Q＞</span>
                如果某一週不小心挑戰失敗，是否能再繼續挑戰後面關卡？
              </p>
              <p className="text-white">
                <span className="text-[#F24C4C] mr-3">＜A＞</span>
  ...
  return (
    <div className="flex justify-center min-h-screen relative bg-[#061B34]">
      <div className="max-w-[1440px] w-full flex flex-col items-center pt-24 lg:pt-24 lg:pb-12 relative">
        ...
        <div className="w-screen max-w-[1400px] border-8 border-solid border-white rounded-xl">
          ...
          <div className="bg-[#434444] p-12">{tabComponent}</div>
        </div>
        <div className="bg-white w-[175px] h-[85px]" />
        <div className="bg-white max-w-[650px] w-3/5 h-8 rounded-tl-xl rounded-tr-xl" />
      </div>
    </div>
  );
};
