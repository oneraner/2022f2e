  ...
  return (
    <div className="flex justify-center min-h-screen relative bg-[#061b34] overflow-hidden">
      <div className="max-w-[1440px] w-full flex flex-col items-center pt-24">
        <h3 id="description" className="h3 text-5xl mb-[70px]">
          活動說明
        </h3>
        <div className="h-2 bg-[#F19AFF] w-full" />
        <div className="w-full flex justify-evenly">
          <div
            id="time"
            className="flex flex-col items-center relative pt-[84px]"
          >
            <div className="absolute -top-[34px] left-1/2 -translate-x-1/2 border-solid border-t-[30px] border-b-[30px] border-l-[52px] border-t-transparent border-r-transparent border-b-transparent border-l-[#f19aff]" />
            <p className="text-white text-[40px] mb-9">報名時間</p>
          ...
          >
            <div className="absolute -top-[34px] left-1/2 -translate-x-1/2 border-solid border-t-[30px] border-b-[30px] border-l-[52px] border-t-transparent border-r-transparent border-b-transparent border-l-[#f19aff]" />
            <p className="text-white text-[40px] mb-9">登錄作品</p>
          ...
          >
            <div className="absolute -top-[34px] left-1/2 -translate-x-1/2 border-solid border-t-[30px] border-b-[30px] border-l-[52px] border-t-transparent border-r-transparent border-b-transparent border-l-[#f19aff]" />
            <p className="text-white text-[40px] mb-9">額外競賽</p>
